...
class PasswordResetConfirmation extends React.Component {
  ...
  onBlurPassword1(password) {
    this.updatePasswordState(password, this.state.password2);
    this.validatePassword(password);
  }

  onBlurPassword2(password) {
    this.updatePasswordState(this.state.password1, password);
  }

  updatePasswordState(password1, password2) {
    this.setState({
      password1,
      password2,
