...
class IDVerificationService(object):
    ...
    @classmethod
    def user_is_verified(self, user, earliest_allowed_date=None):
        """
        ...
        """
        return self.verified_query(earliest_allowed_date).filter(user=user).exists()

    @classmethod
    def verified_query(self, earliest_allowed_date=None):
        """
    ...
    @classmethod
    def verifications_for_user(self, user):
        """
    ...
    @classmethod
    def get_verified_users(self, users):
        """
        Return the list of user ids that have non expired verifications from the given list of users.
        """
        return self.verified_query().filter(user__in=users).select_related('user')

    @classmethod
    def verification_valid_or_pending(self, user, earliest_allowed_date=None, queryset=None):
        """
    ...
    @classmethod
    def get_expiration_datetime(self, user, queryset=None):
        """
    ...
    @classmethod
    def user_has_valid_or_pending(self, user, earliest_allowed_date=None, queryset=None):
        """
        ...
        """
        return self.verification_valid_or_pending(user, earliest_allowed_date, queryset).exists()
    ...
    def user_status(self, user):
        ...
        elif self.user_has_valid_or_pending(user):
    ...
    @classmethod
    def verification_status_for_user(self, user, user_enrollment_mode, user_is_verified=None):
        """
        ...
        if user_is_verified is None:
            user_is_verified = self.user_is_verified(user)
